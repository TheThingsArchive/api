...
function serialize_lorawan_Device(arg) {
  if (!(arg instanceof ttn_protocol_lorawan_device_pb.Device)) {
...
function deserialize_lorawan_Device(buffer_arg) {
  return ttn_protocol_lorawan_device_pb.Device.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lorawan_DeviceIdentifier(arg) {
  if (!(arg instanceof ttn_protocol_lorawan_device_pb.DeviceIdentifier)) {
...
function deserialize_lorawan_DeviceIdentifier(buffer_arg) {
  return ttn_protocol_lorawan_device_pb.DeviceIdentifier.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var DeviceManagerService = exports.DeviceManagerService = {
  getDevice: {
    ...
    requestType: ttn_protocol_lorawan_device_pb.DeviceIdentifier,
    responseType: ttn_protocol_lorawan_device_pb.Device,
  ...
  setDevice: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_protocol_lorawan_device_pb.Device,
