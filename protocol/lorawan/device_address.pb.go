...
func (*PrefixesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_144b50d8b7165fe2, []int{0}
}
...
func (m *PrefixesRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrefixesRequest.Merge(m, src)
}
...
func (*PrefixesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_144b50d8b7165fe2, []int{1}
}
...
func (m *PrefixesResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrefixesResponse.Merge(m, src)
}
...
func (*PrefixesResponse_PrefixMapping) Descriptor() ([]byte, []int) {
	return fileDescriptor_144b50d8b7165fe2, []int{1, 0}
}
...
func (m *PrefixesResponse_PrefixMapping) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PrefixesResponse_PrefixMapping.Merge(m, src)
}
...
func (*DevAddrRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_144b50d8b7165fe2, []int{2}
}
...
func (m *DevAddrRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DevAddrRequest.Merge(m, src)
}
...
func (*DevAddrResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_144b50d8b7165fe2, []int{3}
}
...
func (m *DevAddrResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DevAddrResponse.Merge(m, src)
}
...
func (m *DevAddrResponse) GetDevAddr() []byte {
	if m != nil {
		return m.DevAddr
	}
	return nil
...
func init() {
	proto.RegisterFile("github.com/TheThingsNetwork/api/protocol/lorawan/device_address.proto", fileDescriptor_144b50d8b7165fe2)
}
func init() {
	golang_proto.RegisterFile("github.com/TheThingsNetwork/api/protocol/lorawan/device_address.proto", fileDescriptor_144b50d8b7165fe2)
}

var fileDescriptor_144b50d8b7165fe2 = []byte{
	// 472 bytes of a gzipped FileDescriptorProto
	,
}
...
func (*UnimplementedDevAddrManagerServer) GetPrefixes(ctx context.Context, req *PrefixesRequest) (*PrefixesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPrefixes not implemented")
}
func (*UnimplementedDevAddrManagerServer) GetDevAddr(ctx context.Context, req *DevAddrRequest) (*DevAddrResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetDevAddr not implemented")
}
		...
		for iNdEx := len(m.Prefixes) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintDeviceAddress(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0xa
		}
...
func (m *PrefixesResponse_PrefixMapping) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Usage) > 0 {
		for iNdEx := len(m.Usage) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintDeviceAddress(dAtA, i, uint64(len(m.Usage[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *DevAddrResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DevAddr) > 0 {
		...
		i = encodeVarintDeviceAddress(dAtA, i, uint64(len(m.DevAddr)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (this *PrefixesResponse) String() string {
	...
	repeatedStringForPrefixes := "[]*PrefixesResponse_PrefixMapping{"
	for _, f := range this.Prefixes {
		repeatedStringForPrefixes += strings.Replace(fmt.Sprintf("%v", f), "PrefixesResponse_PrefixMapping", "PrefixesResponse_PrefixMapping", 1) + ","
	}
...
func skipDeviceAddress(dAtA []byte) (n int, err error) {
	...
	for iNdEx < l {
		...
		case 4:
			if depth == 0 {
				return 0, ErrUnexpectedEndOfGroupDeviceAddress
			}
			depth--
		case 5:
			iNdEx += 4
