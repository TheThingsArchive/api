...
proto.lorawan.PrefixesResponse.PrefixMapping.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    usageList: (f = jspb.Message.getRepeatedField(msg, 2)) == null ? undefined : f
  };
...
/**
 * @param {string} value
 * @return {!proto.lorawan.PrefixesResponse.PrefixMapping} returns this
 */
 ...
 * @return {!proto.lorawan.PrefixesResponse} returns this
*/
...
/**
 * @param {!Array<string>} value
 * @return {!proto.lorawan.DevAddrRequest} returns this
 */
 ...
 * @return {!proto.lorawan.DevAddrResponse} returns this
 */
