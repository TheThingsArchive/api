...
public final class DevAddrManagerGrpc {
  ...
  public static final io.grpc.MethodDescriptor<lorawan.DeviceAddress.PrefixesRequest,
      lorawan.DeviceAddress.PrefixesResponse> METHOD_GET_PREFIXES =
      io.grpc.MethodDescriptor.<lorawan.DeviceAddress.PrefixesRequest, lorawan.DeviceAddress.PrefixesResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "lorawan.DevAddrManager", "GetPrefixes"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              lorawan.DeviceAddress.PrefixesRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              lorawan.DeviceAddress.PrefixesResponse.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<lorawan.DeviceAddress.DevAddrRequest,
      lorawan.DeviceAddress.DevAddrResponse> METHOD_GET_DEV_ADDR =
      io.grpc.MethodDescriptor.<lorawan.DeviceAddress.DevAddrRequest, lorawan.DeviceAddress.DevAddrResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "lorawan.DevAddrManager", "GetDevAddr"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              lorawan.DeviceAddress.DevAddrRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              lorawan.DeviceAddress.DevAddrResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class DevAddrManagerImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getPrefixes(lorawan.DeviceAddress.PrefixesRequest request,
        io.grpc.stub.StreamObserver<lorawan.DeviceAddress.PrefixesResponse> responseObserver) {
     ...
     * </pre>
     */
    public void getDevAddr(lorawan.DeviceAddress.DevAddrRequest request,
        io.grpc.stub.StreamObserver<lorawan.DeviceAddress.DevAddrResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                lorawan.DeviceAddress.PrefixesRequest,
                lorawan.DeviceAddress.PrefixesResponse>(
                  this, METHODID_GET_PREFIXES)))
          .addMethod(
            METHOD_GET_DEV_ADDR,
            asyncUnaryCall(
              new MethodHandlers<
                lorawan.DeviceAddress.DevAddrRequest,
                lorawan.DeviceAddress.DevAddrResponse>(
  ...
  public static final class DevAddrManagerBlockingStub extends io.grpc.stub.AbstractStub<DevAddrManagerBlockingStub> {
     ...
     * </pre>
     */
    public lorawan.DeviceAddress.PrefixesResponse getPrefixes(lorawan.DeviceAddress.PrefixesRequest request) {
     ...
     * </pre>
     */
    public lorawan.DeviceAddress.DevAddrResponse getDevAddr(lorawan.DeviceAddress.DevAddrRequest request) {
      return blockingUnaryCall(
  ...
  public static final class DevAddrManagerFutureStub extends io.grpc.stub.AbstractStub<DevAddrManagerFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<lorawan.DeviceAddress.PrefixesResponse> getPrefixes(
        lorawan.DeviceAddress.PrefixesRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<lorawan.DeviceAddress.DevAddrResponse> getDevAddr(
        lorawan.DeviceAddress.DevAddrRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PREFIXES:
          serviceImpl.getPrefixes((lorawan.DeviceAddress.PrefixesRequest) request,
              (io.grpc.stub.StreamObserver<lorawan.DeviceAddress.PrefixesResponse>) responseObserver);
          break;
        case METHODID_GET_DEV_ADDR:
          serviceImpl.getDevAddr((lorawan.DeviceAddress.DevAddrRequest) request,
              (io.grpc.stub.StreamObserver<lorawan.DeviceAddress.DevAddrResponse>) responseObserver);
          break;
        default:
  ...
  private static final class DevAddrManagerDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return lorawan.DeviceAddress.getDescriptor();
    }
  }
