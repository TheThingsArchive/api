...
function serialize_broker_ActivationChallengeRequest(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.ActivationChallengeRequest)) {
...
function deserialize_broker_ActivationChallengeRequest(buffer_arg) {
  return ttn_broker_broker_pb.ActivationChallengeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_broker_ActivationChallengeResponse(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.ActivationChallengeResponse)) {
...
function deserialize_broker_ActivationChallengeResponse(buffer_arg) {
  return ttn_broker_broker_pb.ActivationChallengeResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_handler_Application(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.Application)) {
...
function deserialize_handler_Application(buffer_arg) {
  return ttn_handler_handler_pb.Application.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_ApplicationIdentifier(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.ApplicationIdentifier)) {
...
function deserialize_handler_ApplicationIdentifier(buffer_arg) {
  return ttn_handler_handler_pb.ApplicationIdentifier.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_Device(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.Device)) {
...
function deserialize_handler_Device(buffer_arg) {
  return ttn_handler_handler_pb.Device.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_handler_DeviceIdentifier(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.DeviceIdentifier)) {
...
function deserialize_handler_DeviceIdentifier(buffer_arg) {
  return ttn_handler_handler_pb.DeviceIdentifier.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_DeviceList(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.DeviceList)) {
...
function deserialize_handler_DeviceList(buffer_arg) {
  return ttn_handler_handler_pb.DeviceList.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_DryDownlinkMessage(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.DryDownlinkMessage)) {
...
function deserialize_handler_DryDownlinkMessage(buffer_arg) {
  return ttn_handler_handler_pb.DryDownlinkMessage.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_DryDownlinkResult(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.DryDownlinkResult)) {
...
function deserialize_handler_DryDownlinkResult(buffer_arg) {
  return ttn_handler_handler_pb.DryDownlinkResult.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_DryUplinkMessage(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.DryUplinkMessage)) {
...
function deserialize_handler_DryUplinkMessage(buffer_arg) {
  return ttn_handler_handler_pb.DryUplinkMessage.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_DryUplinkResult(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.DryUplinkResult)) {
...
function deserialize_handler_DryUplinkResult(buffer_arg) {
  return ttn_handler_handler_pb.DryUplinkResult.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_handler_SimulatedUplinkMessage(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.SimulatedUplinkMessage)) {
...
function deserialize_handler_SimulatedUplinkMessage(buffer_arg) {
  return ttn_handler_handler_pb.SimulatedUplinkMessage.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_handler_StatusRequest(arg) {
  if (!(arg instanceof ttn_handler_handler_pb.StatusRequest)) {
...
function deserialize_handler_StatusRequest(buffer_arg) {
  return ttn_handler_handler_pb.StatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var HandlerService = exports.HandlerService = {
  activationChallenge: {
    ...
    requestType: ttn_broker_broker_pb.ActivationChallengeRequest,
    responseType: ttn_broker_broker_pb.ActivationChallengeResponse,
...
var ApplicationManagerService = exports.ApplicationManagerService = {
  ...
  registerApplication: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.ApplicationIdentifier,
  ...
  getApplication: {
    ...
    responseStream: false,
    requestType: ttn_handler_handler_pb.ApplicationIdentifier,
    responseType: ttn_handler_handler_pb.Application,
    requestSerialize: serialize_handler_ApplicationIdentifier,
    requestDeserialize: deserialize_handler_ApplicationIdentifier,
  ...
  setApplication: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.Application,
    responseType: google_protobuf_empty_pb.Empty,
  ...
  getDevice: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.DeviceIdentifier,
    responseType: ttn_handler_handler_pb.Device,
  ...
  setDevice: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.Device,
    responseType: google_protobuf_empty_pb.Empty,
  ...
  getDevicesForApplication: {
    ...
    responseStream: false,
    requestType: ttn_handler_handler_pb.ApplicationIdentifier,
    responseType: ttn_handler_handler_pb.DeviceList,
    requestSerialize: serialize_handler_ApplicationIdentifier,
    requestDeserialize: deserialize_handler_ApplicationIdentifier,
  ...
  dryDownlink: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.DryDownlinkMessage,
    responseType: ttn_handler_handler_pb.DryDownlinkResult,
  ...
  dryUplink: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.DryUplinkMessage,
    responseType: ttn_handler_handler_pb.DryUplinkResult,
  ...
  simulateUplink: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.SimulatedUplinkMessage,
    responseType: google_protobuf_empty_pb.Empty,
...
var HandlerManagerService = exports.HandlerManagerService = {
  getStatus: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_handler_handler_pb.StatusRequest,
    responseType: ttn_handler_handler_pb.Status,
