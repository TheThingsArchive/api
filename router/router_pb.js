 ...
 * @return {!proto.router.UplinkMessage} returns this
 */
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.router.DownlinkMessage} returns this
 */
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.router.DeviceActivationRequest} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.router.GatewayStatusRequest} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.router.GatewayStatusResponse} returns this
 */
 ...
 * @return {!proto.router.Status} returns this
*/
...
proto.router.Status.prototype.clearGatewayStatus = function() {
  return this.setGatewayStatus(undefined);
};
