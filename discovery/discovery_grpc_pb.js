...
function deserialize_discovery_Announcement(buffer_arg) {
  return ttn_discovery_discovery_pb.Announcement.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_discovery_AnnouncementsResponse(arg) {
  if (!(arg instanceof ttn_discovery_discovery_pb.AnnouncementsResponse)) {
...
function deserialize_discovery_AnnouncementsResponse(buffer_arg) {
  return ttn_discovery_discovery_pb.AnnouncementsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_discovery_GetByAppEUIRequest(arg) {
  if (!(arg instanceof ttn_discovery_discovery_pb.GetByAppEUIRequest)) {
...
function deserialize_discovery_GetByAppEUIRequest(buffer_arg) {
  return ttn_discovery_discovery_pb.GetByAppEUIRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_discovery_GetByAppIDRequest(arg) {
  if (!(arg instanceof ttn_discovery_discovery_pb.GetByAppIDRequest)) {
...
function deserialize_discovery_GetRequest(buffer_arg) {
  return ttn_discovery_discovery_pb.GetRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_discovery_GetServiceRequest(arg) {
  if (!(arg instanceof ttn_discovery_discovery_pb.GetServiceRequest)) {
...
function deserialize_discovery_GetServiceRequest(buffer_arg) {
  return ttn_discovery_discovery_pb.GetServiceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_discovery_MetadataRequest(arg) {
  if (!(arg instanceof ttn_discovery_discovery_pb.MetadataRequest)) {
...
function deserialize_discovery_MetadataRequest(buffer_arg) {
  return ttn_discovery_discovery_pb.MetadataRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var DiscoveryService = exports.DiscoveryService = {
  ...
  announce: {
    ...
    requestType: ttn_discovery_discovery_pb.Announcement,
  ...
  getAll: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_discovery_discovery_pb.GetServiceRequest,
    responseType: ttn_discovery_discovery_pb.AnnouncementsResponse,
  ...
  get: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_discovery_discovery_pb.GetRequest,
  ...
  addMetadata: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_discovery_discovery_pb.MetadataRequest,
    responseType: google_protobuf_empty_pb.Empty,
  ...
  getByAppID: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_discovery_discovery_pb.GetByAppIDRequest,
    responseType: ttn_discovery_discovery_pb.Announcement,
  ...
  getByAppEUI: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_discovery_discovery_pb.GetByAppEUIRequest,
    responseType: ttn_discovery_discovery_pb.Announcement,
