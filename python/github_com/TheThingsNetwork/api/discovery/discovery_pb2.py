...
AnnouncementsResponse = _reflection.GeneratedProtocolMessageType('AnnouncementsResponse', (_message.Message,), {
...
GetByAppIDRequest = _reflection.GeneratedProtocolMessageType('GetByAppIDRequest', (_message.Message,), {
...
GetByGatewayIDRequest = _reflection.GeneratedProtocolMessageType('GetByGatewayIDRequest', (_message.Message,), {
...
GetByAppEUIRequest = _reflection.GeneratedProtocolMessageType('GetByAppEUIRequest', (_message.Message,), {
...
_DISCOVERY = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    serialized_options=b'\202\323\344\223\002\037\022\035/announcements/{service_name}',
  ),
  _descriptor.MethodDescriptor(
    name='Get',
    ...
    serialized_options=b'\202\323\344\223\002$\022\"/announcements/{service_name}/{id}',
  ),
  _descriptor.MethodDescriptor(
    name='AddMetadata',
