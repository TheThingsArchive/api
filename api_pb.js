...
proto.api.Percentiles.toObject = function(includeInstance, msg) {
  var f, obj = {
    percentile1: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    percentile5: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
    percentile10: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
    percentile25: jspb.Message.getFloatingPointFieldWithDefault(msg, 4, 0.0),
    percentile50: jspb.Message.getFloatingPointFieldWithDefault(msg, 5, 0.0),
    percentile75: jspb.Message.getFloatingPointFieldWithDefault(msg, 6, 0.0),
    percentile90: jspb.Message.getFloatingPointFieldWithDefault(msg, 7, 0.0),
    percentile95: jspb.Message.getFloatingPointFieldWithDefault(msg, 8, 0.0),
    percentile99: jspb.Message.getFloatingPointFieldWithDefault(msg, 9, 0.0)
  };
...
/**
 * @param {number} value
 * @return {!proto.api.Percentiles} returns this
 */
...
proto.api.Rates.toObject = function(includeInstance, msg) {
  var f, obj = {
    rate1: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    rate5: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
    rate15: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0)
  };
...
/**
 * @param {number} value
 * @return {!proto.api.Rates} returns this
 */
...
proto.api.SystemStats.Loadstats.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    load5: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
    load15: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0)
  };
...
/**
 * @param {number} value
 * @return {!proto.api.SystemStats.Loadstats} returns this
 */
...
proto.api.SystemStats.CPUStats.toObject = function(includeInstance, msg) {
  var f, obj = {
    user: jspb.Message.getFloatingPointFieldWithDefault(msg, 1, 0.0),
    system: jspb.Message.getFloatingPointFieldWithDefault(msg, 2, 0.0),
    idle: jspb.Message.getFloatingPointFieldWithDefault(msg, 3, 0.0),
...
/**
 * @param {number} value
 * @return {!proto.api.SystemStats.CPUStats} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.api.SystemStats.MemoryStats} returns this
 */
 ...
 * @return {!proto.api.SystemStats} returns this
*/
...
proto.api.ComponentStats.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    gcCpuFraction: jspb.Message.getFloatingPointFieldWithDefault(msg, 5, 0.0)
  };
...
/**
 * @param {number} value
 * @return {!proto.api.ComponentStats.CPUStats} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.api.ComponentStats.MemoryStats} returns this
 */
...
/**
 * @param {number} value
 * @return {!proto.api.ComponentStats} returns this
 */
