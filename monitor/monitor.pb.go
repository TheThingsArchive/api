...
import (
	...
	networkserver "github.com/TheThingsNetwork/api/networkserver"
	router "github.com/TheThingsNetwork/api/router"
...
func init() {
	proto.RegisterFile("github.com/TheThingsNetwork/api/monitor/monitor.proto", fileDescriptor_4842fb8a8deb1d15)
}
func init() {
	golang_proto.RegisterFile("github.com/TheThingsNetwork/api/monitor/monitor.proto", fileDescriptor_4842fb8a8deb1d15)
}

var fileDescriptor_4842fb8a8deb1d15 = []byte{
...
func (*UnimplementedMonitorServer) RouterStatus(srv Monitor_RouterStatusServer) error {
	return status.Errorf(codes.Unimplemented, "method RouterStatus not implemented")
}
...
func (*UnimplementedMonitorServer) GatewayUplink(srv Monitor_GatewayUplinkServer) error {
	return status.Errorf(codes.Unimplemented, "method GatewayUplink not implemented")
}
...
func (*UnimplementedMonitorServer) BrokerStatus(srv Monitor_BrokerStatusServer) error {
	return status.Errorf(codes.Unimplemented, "method BrokerStatus not implemented")
}
func (*UnimplementedMonitorServer) BrokerUplink(srv Monitor_BrokerUplinkServer) error {
	return status.Errorf(codes.Unimplemented, "method BrokerUplink not implemented")
}
func (*UnimplementedMonitorServer) BrokerDownlink(srv Monitor_BrokerDownlinkServer) error {
	return status.Errorf(codes.Unimplemented, "method BrokerDownlink not implemented")
}
func (*UnimplementedMonitorServer) HandlerStatus(srv Monitor_HandlerStatusServer) error {
	return status.Errorf(codes.Unimplemented, "method HandlerStatus not implemented")
}
func (*UnimplementedMonitorServer) HandlerUplink(srv Monitor_HandlerUplinkServer) error {
	return status.Errorf(codes.Unimplemented, "method HandlerUplink not implemented")
}
func (*UnimplementedMonitorServer) HandlerDownlink(srv Monitor_HandlerDownlinkServer) error {
	return status.Errorf(codes.Unimplemented, "method HandlerDownlink not implemented")
}
func (*UnimplementedMonitorServer) NetworkServerStatus(srv Monitor_NetworkServerStatusServer) error {
	return status.Errorf(codes.Unimplemented, "method NetworkServerStatus not implemented")
}
