...
func init() {
	proto.RegisterFile("github.com/TheThingsNetwork/api/monitor/monitor.proto", fileDescriptor_monitor_ef05760ea4871c9f)
}

var fileDescriptor_monitor_ef05760ea4871c9f = []byte{
