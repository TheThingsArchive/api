...
function serialize_broker_ApplicationHandlerRegistration(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.ApplicationHandlerRegistration)) {
...
function deserialize_broker_ApplicationHandlerRegistration(buffer_arg) {
  return ttn_broker_broker_pb.ApplicationHandlerRegistration.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_broker_DeviceActivationRequest(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.DeviceActivationRequest)) {
...
function deserialize_broker_DeviceActivationRequest(buffer_arg) {
  return ttn_broker_broker_pb.DeviceActivationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_broker_DeviceActivationResponse(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.DeviceActivationResponse)) {
...
function deserialize_broker_DeviceActivationResponse(buffer_arg) {
  return ttn_broker_broker_pb.DeviceActivationResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
function serialize_broker_StatusRequest(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.StatusRequest)) {
...
function deserialize_broker_StatusRequest(buffer_arg) {
  return ttn_broker_broker_pb.StatusRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_broker_SubscribeRequest(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.SubscribeRequest)) {
...
function deserialize_broker_SubscribeRequest(buffer_arg) {
  return ttn_broker_broker_pb.SubscribeRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_broker_UplinkMessage(arg) {
  if (!(arg instanceof ttn_broker_broker_pb.UplinkMessage)) {
...
function deserialize_broker_UplinkMessage(buffer_arg) {
  return ttn_broker_broker_pb.UplinkMessage.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var BrokerService = exports.BrokerService = {
  ...
  associate: {
    ...
    requestStream: true,
    responseStream: true,
    requestType: ttn_broker_broker_pb.UplinkMessage,
  ...
  subscribe: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: ttn_broker_broker_pb.SubscribeRequest,
  ...
  activate: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_broker_broker_pb.DeviceActivationRequest,
    responseType: ttn_broker_broker_pb.DeviceActivationResponse,
...
var BrokerManagerService = exports.BrokerManagerService = {
  ...
  registerApplicationHandler: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_broker_broker_pb.ApplicationHandlerRegistration,
    responseType: google_protobuf_empty_pb.Empty,
  ...
  getStatus: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: ttn_broker_broker_pb.StatusRequest,
    responseType: ttn_broker_broker_pb.Status,
